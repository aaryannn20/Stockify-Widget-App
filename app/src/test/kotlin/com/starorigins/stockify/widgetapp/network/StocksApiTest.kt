...
class StocksApiTest : BaseUnitTest() {
  ...
  internal lateinit var mockPrefs: com.starorigins.stockify.widgetapp.AppPreferences
  ...
  @Before fun initMocks() {
    runBlocking {
      ...
      mockPrefs = Mocker.provide(com.starorigins.stockify.widgetapp.AppPreferences::class)
