...
class AlarmSchedulerTest : BaseUnitTest() {
  ...
  private lateinit var appPreferences: com.starorigins.stockify.widgetapp.AppPreferences
  private lateinit var alarmScheduler: AlarmScheduler

  @Before fun init() {
    clock = mock()
    sharedPreferences = ApplicationProvider.getApplicationContext<Context>().getSharedPreferences(
        com.starorigins.stockify.widgetapp.AppPreferences.PREFS_NAME, Context.MODE_PRIVATE)
    appPreferences = com.starorigins.stockify.widgetapp.AppPreferences(sharedPreferences, clock)
  ...
  private fun setStartAndEndTime(startTime: String, endTime: String) {
    sharedPreferences.edit().putString(com.starorigins.stockify.widgetapp.AppPreferences.START_TIME, startTime).apply()
    sharedPreferences.edit().putString(com.starorigins.stockify.widgetapp.AppPreferences.END_TIME, endTime).apply()
  }
