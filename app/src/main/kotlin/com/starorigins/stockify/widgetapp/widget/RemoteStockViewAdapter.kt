...
import com.starorigins.stockify.widgetapp.widget.WidgetData.Companion.ChangeType
...
class RemoteStockViewAdapter(private val widgetId: Int) : RemoteViewsService.RemoteViewsFactory {
  ...
  private fun getFontSize(): Float {
    val size = sharedPreferences.getInt(com.starorigins.stockify.widgetapp.AppPreferences.FONT_SIZE, 1)
    return when (size) {
