...
class AppPreferences @Inject constructor(
  ...
  @NightMode val nightMode: Int
    get() = when (themePref) {
      ...
      FOLLOW_SYSTEM_THEME -> {
        if (supportSystemNightMode) AppCompatDelegate.MODE_NIGHT_YES
  ...
  companion object {
    ...
    const val UPDATE_FILTER = "com.starorigins.stockify.widgetapp.UPDATE"
    const val SETTING_APP_THEME = "com.starorigins.stockify.widgetapp.theme"
    const val SORTED_STOCK_LIST = "SORTED_STOCK_LIST"
    const val PREFS_NAME = "com.starorigins.stockify.widgetapp"
    const val FONT_SIZE = "com.starorigins.stockify.widgetapp.textsize"
