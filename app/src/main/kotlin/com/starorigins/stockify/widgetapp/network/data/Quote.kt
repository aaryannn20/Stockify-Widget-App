...
data class Quote constructor(
  ...
  fun changeString(): String = com.starorigins.stockify.widgetapp.AppPreferences.SELECTED_DECIMAL_FORMAT.format(change)

  fun changeStringWithSign(): String {
    val changeString = com.starorigins.stockify.widgetapp.AppPreferences.SELECTED_DECIMAL_FORMAT.format(change)
    if (change >= 0) {
      return "+$changeString"
    }
    return changeString
  ...
  fun changePercentString(): String =
    "${com.starorigins.stockify.widgetapp.AppPreferences.DECIMAL_FORMAT_2DP.format(changeInPercent)}%"

  fun changePercentStringWithSign(): String {
    val changeString = "${com.starorigins.stockify.widgetapp.AppPreferences.DECIMAL_FORMAT_2DP.format(changeInPercent)}%"
  ...
  fun dividendInfo(): String {
    return if (annualDividendRate <= 0f || annualDividendYield <= 0f) {
      ...
      com.starorigins.stockify.widgetapp.AppPreferences.DECIMAL_FORMAT_2DP.format(annualDividendRate)
    }
  }
  ...
  fun priceString(): String = com.starorigins.stockify.widgetapp.AppPreferences.SELECTED_DECIMAL_FORMAT.format(lastTradePrice)

  fun averagePositionPrice(): String =
    com.starorigins.stockify.widgetapp.AppPreferences.SELECTED_DECIMAL_FORMAT.format(positionPrice())

  fun numSharesString(): String =
    com.starorigins.stockify.widgetapp.AppPreferences.SELECTED_DECIMAL_FORMAT.format(totalPositionShares())

  fun totalSpentString(): String =
    com.starorigins.stockify.widgetapp.AppPreferences.SELECTED_DECIMAL_FORMAT.format(totalPositionPrice())

  fun holdings(): Float = lastTradePrice * totalPositionShares()

  fun holdingsString(): String = com.starorigins.stockify.widgetapp.AppPreferences.SELECTED_DECIMAL_FORMAT.format(holdings())

  fun gainLoss(): Float = holdings() - totalPositionShares() * positionPrice()

  fun gainLossString(): String {
    val gainLoss = gainLoss()
    val gainLossString = com.starorigins.stockify.widgetapp.AppPreferences.SELECTED_DECIMAL_FORMAT.format(gainLoss)
    if (gainLoss >= 0) {
  ...
  fun gainLossPercentString(): String {
    ...
    val gainLossString = "${com.starorigins.stockify.widgetapp.AppPreferences.DECIMAL_FORMAT_2DP.format(gainLossPercent)}%"
  ...
  fun dayChangeString(): String {
    ...
    val dayChangeString = com.starorigins.stockify.widgetapp.AppPreferences.SELECTED_DECIMAL_FORMAT.format(dayChange)
    if (dayChange > 0) {
